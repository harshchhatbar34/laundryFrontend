    ...
    <ScreenWrapper>
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 100 }}
        ...
        <View style={{ flexDirection: 'row' }}>
          <StatCard icon="receipt-outline" label="Orders" value={stats?.totalOrders || 0} delay={0} />
          <StatCard icon="cash-outline" label="Revenue" value={formatPrice(stats?.totalRevenue || 0)} color={theme.colors.success} delay={100} />
        </View>
        <View style={{ flexDirection: 'row', marginTop: 4 }}>
          <StatCard icon="people-outline" label="Helpers" value={stats?.activeHelpers || 0} color="#8B5CF6" delay={200} />
          <StatCard icon="star-outline" label="Rating" value={stats?.avgRating?.toFixed(1) || '0.0'} color="#F59E0B" delay={300} />
        </View>
